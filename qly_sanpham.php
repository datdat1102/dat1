        ...
        <div class="content">
            ...
            <tr>
                ...
                <tr>
                    <td>Ảnh minh họa</td>
					<td colspan="5">
                        <img style="width:100px" src='../public/image/<?php echo $row['hinh_anh']; ?>'>
               ...
               ?>
                ...
                <td>Trạng thái</td>
                    <td>
                    <input type="radio" name="trangthai" value="1" checked="1">Còn hàng
                    <input type="radio" name="trangthai" value="2">Hết hàng
                    </td>
                </tr>
                <tr>
                <td colspan="4">
            ...
            ?>
                ...
                or ten_nhan_hieu like '%$search%' or ten_loai like '%$search%'");
                    ...
                    <tr class ="tr">
                            ...
                            <td style='text-align: center'><img width='50' height='50' src='../public/image/<?php echo $row["hinh_anh"];?>' alt='Lỗi hiển thị ảnh'></td>
                    ...
                    ?>
                        <tr class ="tr">
                            ...
                            <?php 
                                if ($row['trang_thai'] == 1) {
                                    echo "<td><a 
                                    href='xl_ttsp.php?id=" .$row['ma_sp'] ."&trangthai=" .$row['trang_thai'] ."' >"
                                       ." <img src='../admin/image/Ok-icon.png' alt='tick'>
                                   </a> </td>";
                                } else {
                                    echo  "<td><a href='xl_ttsp.php?id=" .$row['ma_sp'] ."&trangthai=" .$row['trang_thai'] ."'>"
                                    ."<img src='../admin/image/Lock-icon.png' alt='lock'>
                                   </a></td>";

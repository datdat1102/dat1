...
<link rel="stylesheet" href="./css/header.css">
    ...
    <?php
        ...
        <table>
        <tr>
                <td><input type="number" name="ma_hd" value="<?php echo $row['ma_hd'] ?>" readonly></td>
            </tr>
            <tr>
                <td>Trạng thái</td>
                <td>
                    <input type="radio" name="trangthai" value="0" checked ="0">Đang xử lý
                    <input type="radio" name="trangthai" value="1">Đang giao hàng
                    <input type="radio" name="trangthai" value="2">Hoàn thành
                </td>
            </tr>
            <tr>
                <td>
